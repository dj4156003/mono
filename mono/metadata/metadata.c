...
#define CUSTOMASSEMBLYREF_SCHEMA_OFFSET CUSTOMDEBUGINFORMATION_SCHEMA_OFFSET + 4
    MONO_MT_STRING_IDX,  /* Name */
    MONO_MT_END,

#define NULL_SCHEMA_OFFSET CUSTOMASSEMBLYREF_SCHEMA_OFFSET + 2
	MONO_MT_END
};
...
table_description [] = {
    ...
    CUSTOMASSEMBLYREF_SCHEMA_OFFSET,
	NULL_SCHEMA_OFFSET,
	NULL_SCHEMA_OFFSET,
